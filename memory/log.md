...
TETA+PI (`teta-pi-e0`, session "TTPI · MANAGER"): one message sent — :8200 up, please verify the vhost; no root requests. Answer: (pending at time of writing — see addendum below when received).
